  ...
  <div class="shop-info" ref="shopInfo">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" :class="showListColorType[support.type]"
...
export default {
  data () {
    return {
      showListColorType: ['activity-green', 'activity-red', 'activity-orange']
    }
  },
  computed: {
    ...mapState(['shopinfo'])
  ...
  methods: {
    _initScroll () {
      ...
      this.scrollImg = new Bscroll('.pic-wrapper', {
        scrollX: true
      })
    }
  }
