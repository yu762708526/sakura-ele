<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="toggleDetail">
    ...
    <div class="shop-header-discounts" v-if="shopinfo.supports" @click="toggleSupports">
      <div class="discounts-left">
        <div class="activity" :class="colorClass[shopinfo.supports[0].type]">
          <span class="content-tag">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="showDetail">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="closeDetail">
    ...
    <transition name="fadetwo">
      <div class="activity-sheet" v-show="showSupports">
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item " :class="colorClass[item.type]" v-for="(item, index) in shopinfo.supports"
              :key="index">
              <span class="content-tag">
          ...
          <div class="activity-sheet-close" @click="closeSupports">
            <span class="iconfont icon-close"> &#xe62b;</span>
          </div>
        </div>
