<template>
  <div class="shop_container">
    <ul class="shop_list" v-if="shoplist.length">
      <router-link :to="{path:'/shop',query:{id:shops.id}}" tag="li" class="shop_li border-1px"
          ...
          <div class="shop_right">
            <section class="shop_detail_header">
              ...
              <ul class="shop_detail_ul">
                <li class="supports" v-for="(shop, index) in shops.supports" :key="index">{{shop.icon_name}}</li>
              </ul>
            </section>
            <section class="shop_rating_order">
              <section class="shop_rating_order_left">
                <start :score="shops.rating" :size="24"></start>
