<template>
  <div>
    ...
    <div class="list-mask" v-if="listShow" @click="showListClick"></div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    listShow () {
      ...
      if (this.showList) {
        // this.$nextTick(() => {
        //   // 如果没有实例  才创建  否则每一次打开list都会创建 派发一个click
        //   if (!this.scroll) {
